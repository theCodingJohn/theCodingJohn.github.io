    ...
    <main className="main" >
      ...
      <section className='hero'>
        ...
        <section className="container social-icon-container">
          <a rel="noreferrer noopener" href="https://github.com/theCodingJohn" target="_blank" className="social-icon social-icon--github">
          ...
          <a rel="noreferrer noopener" href="https://codepen.io/jccnnn" target="_blank" className="social-icon social-icon--codepen">
          ...
          <a rel="noreferrer noopener" href="https://www.linkedin.com/in/john-carlo-cunanan-11847a17a" target="_blank" className="social-icon social-icon--linkedIn">
